...
export async function sendCredentialUpdateEmail(credentials: { username: string; password: string }) {
    try {
        ...
        const mailOptions = {
            ...
            to: "muhammedjibinziyadt@gmail.com",
            subject: "Security Alert: Admin Credentials Updated - ishal rabeeh",
            text: `
Hello,

This is a security notification to inform you that the admin credentials for the Ishal Rabeeh portal have just been updated.
